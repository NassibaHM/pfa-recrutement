    ...
    <div class="flex">
        ...
        <main class="flex-1 p-8">
            <div class="card-modern rounded-xl shadow-sm p-6 animate-fade-up">
                <h2 class="text-2xl font-bold text-[#0f172a] mb-6">Définir les Critères du Poste</h2>
                ...
                <form action="{{ route('criteres.store') }}" method="POST">
                    ...
                    <!-- Nom du Profil -->
                    <div class="mb-6">
                        <label for="profile" class="block font-semibold text-[#0f172a] mb-2">Nom du Profil</label>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="description" name="description" rows="4" 
                                  required class="input-modern w-full px-4 py-2 rounded-lg text-[#0f172a]">{{ old('description') }}</textarea>
                        @error('description') 
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p> 
                        @enderror
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <input type="text" name="competences_techniques" 
                                       ...
                                       value="{{ old('competences_techniques') }}" 
                                ...
                                <input type="number" name="poids_competence_technique" 
                                       min="0" max="100" 
                                       value="{{ old('poids_competence_technique') }}" 
                            ...
                            <div>
                                <input type="text" name="competences_linguistiques" 
                                       ...
                                       value="{{ old('competences_linguistiques') }}" 
                                       required class="input-modern w-full px-4 py-2 rounded-lg text-[#0f172a] mb-3">
                                <input type="number" name="poids_competence_linguistique" 
                                       min="0" max="100" 
                                       value="{{ old('poids_competence_linguistique') }}" 
                                       required placeholder="Poids (%)" 
                                       class="input-modern w-full px-4 py-2 rounded-lg text-[#0f172a]">
                            </div>
                            <div>
                                <input type="text" name="competences_manageriales" 
                                       ...
                                       value="{{ old('competences_manageriales') }}" 
                                       required class="input-modern w-full px-4 py-2 rounded-lg text-[#0f172a] mb-3">
                                <input type="number" name="poids_competence_manageriale" 
                                       min="0" max="100" 
                                       value="{{ old('poids_competence_manageriale') }}" 
                                       required placeholder="Poids (%)" 
                                       class="input-modern w-full px-4 py-2 rounded-lg text-[#0f172a]">
                            </div>
                        </div>
